...
| Tenant API quota exhaustion (availability)     | Client-side rolling minute and hour limits set below Microsoft's published quotas; `Retry-After` honoured with capped backoff.                                                                                                                                                                                 |
